...
const Login = () => {
  ...
  const [submitted, setSubmitted] = useState(false); // track submit attempts
    ...
    <section className="py-16 xl:pb-56 bg-white overflow-hidden">
      <div className="container px-4 mx-auto">
        <div className="text-center max-w-md mx-auto">
          ...
          {/* Display error message only after submit */}
          {submitted && error && <ErrorMsg message={error?.message} />}

          {/* Display success message */}
          {submitted && success && <SuccessMsg message={success?.message} />}
